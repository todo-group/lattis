use lattis::{
    ...
    write_graph_to_string, write_unitcell_to_string, Basis, CoordinateVector, ExtentVector, Graph,
    Unitcell,
};
...
fn basis_unitcell_and_graph_round_trip_to_xml() {
    ...
    let cell_again =
        read_unitcell_from_str(&cell_xml, "simple").expect("unitcell should round-trip");
